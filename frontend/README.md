# Frontend for plainbi

It was initially setup with the "create react app" template.

The most important readme parts of that template are kept below:
...
## Changing the Page `<title>` and other metadat
